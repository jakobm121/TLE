...
def is_qualification_text(text: Any) -> bool:
    ...
    # Explicit words from API-Tennis and common sportsbook/API variants.
    ...
    # Round shorthand. Keep this conservative to avoid treating normal QF / quarter-finals as qualifying.
    ...
    for t in rows:
        ...
        text = " ".join(
            ...
            for x in (
                ...
                t.get("event_type_type"),
                t.get("event_type_key"),
            )
            if safe_str(x)
        )
